...
{
    public class CascadeFeedforwardNetwork : NeuronalNetwork
    {
        ...
        {
            outputFeedforwardLayer = feedforwardLayer;
        ...
        public override double[] Classify(int[] inputValues)
        {
            ...
            {
                ClassifyLayer(startFeedforwardLayer, inputFeedforwardLayer, layer);
                startFeedforwardLayer = layer;
            }
            ClassifyLayer(startFeedforwardLayer, inputFeedforwardLayer, outputFeedforwardLayer);
        ...
        private void Calculate(double[] inputValues, int[] outputValues)
        {
            ...
            foreach (var layer in hiddenFeedforwardLayers)
            {
                ...
                if (layerCounter > 0)
                {
                    CalculateLayer(inputFeedforwardLayer, layer);
                }
                startFeedforwardLayer = layer;
                layerCounter++;
            }
            CalculateLayer(inputFeedforwardLayer, outputFeedforwardLayer);
            ...
            Backpropagate(outputFeedforwardLayer, inputFeedforwardLayer, outputValues, 0);
        }
        ...
        private void Calculate(double[] inputValues, double outputValue)
        {
            ...
            Backpropagate(outputFeedforwardLayer, inputFeedforwardLayer, outputValue, 0);
        }
            ...
            FeedforwardLayer endfeedforwardLayer, double[] outputValues, int layer)
        {
            ...
            foreach (var matrix in weightMatrixes)
            {
                if (matrix.Item2 == startfeedforwardLayer.Layer && endfeedforwardLayer.Layer == matrix.Item1)
                {
                    weightMatrix = matrix.Item3;
                    break;
                }
            ...
            FeedforwardLayer endfeedforwardLayer, double outputValue, int layer)
        {
            ...
            foreach (var matrix in weightMatrixes)
            {
                if (matrix.Item2 == startfeedforwardLayer.Layer && matrix.Item1 == endfeedforwardLayer.Layer)
                {
                    weightMatrix = matrix.Item3;
                    break;
                }
            ...
            FeedforwardLayer hiddenfeedforwardLayer, FeedforwardLayer outputfeedforwardLayer, int layer)
        {
            ...
            foreach (var matrix in weightMatrixes)
            {
                if (matrix.Item2 == hiddenfeedforwardLayer.Layer)// && matrix.Item1 == inputFeedforwardLayer.Layer)
                {
                    weightMatrix = matrix.Item3;
                }
                else if (matrix.Item2 == outputfeedforwardLayer.Layer && matrix.Item1 == hiddenfeedforwardLayer.Layer)
                {
